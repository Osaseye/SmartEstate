        ...
        <div className="lg:col-span-1 space-y-6">
           ...
           <div className="bg-white rounded-3xl p-6 shadow-sm border border-slate-100">
              ...
              <div className="grid grid-cols-2 gap-3">
                 <Link to="/manager/tenants" className="flex flex-col items-center justify-center p-4 rounded-2xl bg-slate-50 border border-slate-100 hover:bg-white hover:border-slate-200 hover:shadow-md transition-all group">
                 ...
                 <Link to="/manager/payments" className="flex flex-col items-center justify-center p-4 rounded-2xl bg-slate-50 border border-slate-100 hover:bg-white hover:border-slate-200 hover:shadow-md transition-all group">
                 ...
                 <Link to="/manager/community" className="flex flex-col items-center justify-center p-4 rounded-2xl bg-slate-50 border border-slate-100 hover:bg-white hover:border-slate-200 hover:shadow-md transition-all group">
                 ...
                 <Link to="/manager/settings" className="flex flex-col items-center justify-center p-4 rounded-2xl bg-slate-50 border border-slate-100 hover:bg-white hover:border-slate-200 hover:shadow-md transition-all group">
